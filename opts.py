...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data_dir', type=str, default='/media/lily/software-new2/mnt/FairMOT-master/data')
    ...
    # 2023.04.05 挑选loss超参数
    self.parser.add_argument('--det_weight', type=float, default=1,
                                         help='loss weight for deteciton.')
    self.parser.add_argument('--reid_weight', type=float, default=0.1,
                                         help='loss weight for reid.')


    # 2023.03.13 结果保存路径文件名
    self.parser.add_argument('--exp_name', type=str, default='mot17_dla34', help='the same as exp_id')
